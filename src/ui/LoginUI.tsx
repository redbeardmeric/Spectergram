...
export default function LoginUI() {
  ...
  const [strength, setStrength] = useState({ label: "", color: "", gradient: "" });
  ...
  const evaluatePassword = (pwd: string) => {
    ...
    if (pwd.length === 0)
      return { label: "", color: "", gradient: "none" };
    if (passed <= 2)
      return {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-white fade-in">
      <div className="glass p-8 rounded-2xl shadow-lg w-full max-w-sm">
        <h1 className="text-3xl font-bold mb-6 text-center glow">Spectergram</h1>
            ...
            <div className="relative">
              <input
                ...
                style={{
                  ...
                  boxShadow:
                    strength.color && `0 0 12px ${strength.color}88`,
